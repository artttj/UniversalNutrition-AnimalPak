 ...
 */
namespace Mirasvit\CatalogLabel\Block\Adminhtml\Helper;
...
class Image extends \Magento\Framework\Data\Form\Element\AbstractElement
{
     ...
     */
    const ELEMENT_OUTPUT_TEMPLATE = 'Mirasvit_CatalogLabel::template/image_field.phtml';
    ...
    public function createElementOutputBlock()
    {
        ...
        $block = $this->layout->createBlock(
            ...
            'product.labels.form.base.image.element'
        );
    ...
    {
        return $this->url->getUrl('cataloglabel/label/upload');
    }
